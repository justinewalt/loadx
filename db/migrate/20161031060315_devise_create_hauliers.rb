class DeviseCreateHauliers < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :hauliers, :email,                unique: true
    add_index :hauliers, :reset_password_token, unique: true
    # add_index :hauliers, :confirmation_token,   unique: true
    # add_index :hauliers, :unlock_token,         unique: true
  end
end
